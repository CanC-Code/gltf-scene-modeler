...
document.getElementById('convertBtn').onclick = () => setStatus('Voxelize: Not implemented yet');
document.getElementById('paintBtn').onclick = () => setStatus('Paint: Coming soon');
document.getElementById('scaleBtn').onclick = () => setStatus('Scale: Coming soon');
document.getElementById('moveBtn').onclick = () => setStatus('Move: Coming soon');
