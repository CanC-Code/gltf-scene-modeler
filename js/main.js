// js/main.js
// Author: CCVO
// Purpose: Main entry point for GLTF Scene Modeler with sculpting, undo/redo, and ViewGizmo orientation
...
["N","S","E","W"].forEach((dir, i)=>{
  ...
  const pos = [[0,0,10],[0,0,-10],[10,0,0],[-10,0,0]];
  sprite.position.set(...pos[i]);
